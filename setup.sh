...
#   --from-literal=INFLUXDB_USERNAME=schene \
#   --from-literal=INFLUXDB_PASSWORD=schene42 \
#   --from-literal=INFLUXDB_HOST=influxdb

# kubectl create secret generic grafana-creds \
#   --from-literal=GF_SECURITY_ADMIN_USER=schene \
#   --from-literal=GF_SECURITY_ADMIN_PASSWORD=schene42
